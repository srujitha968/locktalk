...
function Home() {
    ...
    const ondataEncrypt = async(e) =>{
        ...
        const res = await axios.post(`https://localhost:8080/encrypt?msg=${msg}&password=${password}`)
    ...
    const onDatadecrypt = async(e) =>{
        ...
        const res = await axios.post(`https://localhost:8080/decrypt?secret=${secret}&password=${password}`)
